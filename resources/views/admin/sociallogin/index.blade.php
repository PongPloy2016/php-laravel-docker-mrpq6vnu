...
<div class="box">
	<div class="box-body">
		...
		<div class="col-md-6">
			...
			<input type="password" value="{{ $env_files['FACEBOOK_CLIENT_SECRET'] }}" name="FACEBOOK_CLIENT_SECRET" class="form-control" aria-label="Facebook Client Secret">
		...
		<div class="col-md-6">
			...
			<div class="input-group">
				<input type="password" value="{{ $env_files['GOOGLE_CLIENT_SECRET'] }}" name="GOOGLE_CLIENT_SECRET" class="form-control" aria-label="Google Client Secret">
				<span class="input-group-addon toggle-password-btn" style="cursor:pointer;" aria-label="Toggle visibility">
					<i class="fa fa-eye" aria-hidden="true"></i>
				</span>
			</div>
		...
		<div class="col-md-6">
			...
			" }}" id="git_lab_box">
				...
				<div class="input-group">
					<input type="password" value="{{ $env_files['GITLAB_CLIENT_SECRET'] }}" name="GITLAB_CLIENT_SECRET" class="form-control" aria-label="GitLab Client Secret">
					<span class="input-group-addon toggle-password-btn" style="cursor:pointer;" aria-label="Toggle visibility">
						<i class="fa fa-eye" aria-hidden="true"></i>
					</span>
				</div>
...
<script type="text/javascript">
  ...
  // Password toggle handled by shared validation-scripts partial
