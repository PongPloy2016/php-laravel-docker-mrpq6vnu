          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group{{ $errors->has('logo') ? ' has-error' : '' }}">
                ...
                {!! Form::file('logo',['accept'=>'image/jpeg,image/jpg,image/png,image/webp', 'aria-label' => 'Upload Logo']) !!}
            ...
            <div class="col-md-6">
              <div class="form-group{{ $errors->has('favicon') ? ' has-error' : '' }}">
                ...
                {!! Form::file('favicon',['accept'=>'image/x-icon,image/ico', 'aria-label' => 'Upload Favicon']) !!}
            ...
            <div class="col-md-6">
               <div class="form-group{{ $errors->has('w_email') ? ' has-error' : '' }}">
                  ...
                  {!! Form::email('w_email', null, ['class' => 'form-control email-input', 'placeholder' => 'eg: example@exampledomain.com', 'required' => 'required', 'maxlength' => '60', 'aria-label' => 'Default Email']) !!}
