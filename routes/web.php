...
Route::group(['middleware'=> 'coming_soon'], function(){
  ...
  Route::post('/videolist/{id}/view', [VideoListController::class, 'incrementView'])->name('videolist.view');
...
Route::group(['middleware'=> 'isadmin'], function(){
  ...
  Route::resource('/admin/gallery', 'AdminGalleryController')->names('gallery');
