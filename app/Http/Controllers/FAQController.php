...
class FAQController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $newfaq = new FAQ;
        try {
           $newfaq->title = strip_tags($request->title);
            $newfaq->details = strip_tags($request->details, '<p><br><strong><em><u><ol><ul><li><a><img><h1><h2><h3><h4><h5><h6><blockquote><pre><code><span><div><hr>');
    ...
    public function update(Request $request,$id)
    {
         $faq = FAQ::find($id);
         try{
            $faq->title = strip_tags($request->title);
            $faq->details = strip_tags($request->details, '<p><br><strong><em><u><ol><ul><li><a><img><h1><h2><h3><h4><h5><h6><blockquote><pre><code><span><div><hr>');
            $faq->save();
