...
var corsOptions = {
  origin: ["https://ict-app-rog5q.ondigitalocean.app","https://ictcoopthai.com", "http://localhost:3000"],
};
  ...
  User.findOne({
    ...
    if (!user) {
      User.create({
        ...
        nationalID: "1234567891563",
        fullName: "สมใจ ใจดี", 
        birthdate: "1989-08-10 00:00:0",
        personalInfo: "",
        accessToken: "",
      })
        .then((user) => {
  ...
  User.findOne({
    ...
    if (!user) {
      User.create({
        ...
        nationalID: "1234567899874",
        fullName: "มีสุข สบายใจ", 
        birthdate: "1979-08-15 00:00:0",
        personalInfo: "",
        accessToken: "",
      })
        .then((user) => {
