        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group{{ $errors->has('per_q_mark') ? ' has-error' : '' }}">
              ...
              <span class="required">*</span>
              {!! Form::number('per_q_mark', null, ['class' => 'form-control positive-number-input', 'placeholder' => 'Please Enter Per Question Mark', 'required' => 'required', 'min' => '0']) !!}
            ...
            <div class="form-group{{ $errors->has('timer') ? ' has-error' : '' }}">
              ...
              {!! Form::number('timer', null, ['class' => 'form-control positive-number-input', 'placeholder' => 'Please Enter Quiz Total Time (In Minutes)', 'min' => '0']) !!}
          ...
          <div class="col-md-6">
            <div style="{{ $topic->amount == NULL ? "display: none" : "" }}" id="doabox2{{ $topic->id }}">
              ...
              <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
               <input value="{{ $topic->amount }}" name="amount" id="doa" type="text" class="form-control positive-number-input" min="0" placeholder="Please Enter Quiz Price" aria-label="Quiz Price">
