              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
                    ...
                    <span class="required">*</span>
                    {!! Form::text('mobile', null, ['class' => 'form-control mobile-input', 'placeholder' => 'eg: +911234567890', 'required' => 'required', 'maxlength' => '15', 'pattern' => '[0-9+]{1,15}', 'aria-label' => 'Mobile Number']) !!}
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <div id="pass" class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                ...
                                <div class="input-group">
                                  <input class="form-control" type="password" value="" placeholder="Enter new password" name="password" aria-label="Password">
                                  <span class="input-group-addon toggle-password-btn" style="cursor:pointer;" aria-label="Toggle password visibility">
                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                  </span>
                                </div>
